		...
		<script>
			...
			function statusChangeCallback(response) {
				...
				if (response.status === 'connected') {
					...
					$(".fb-login").empty();
					$(".fb-login").append('<center><h2><i class="glyphicon glyphicon-cog glyphicon-refresh-animate"></i></h2><h4>Please wait...</h4><h6>หากค้างอยู่หน้านี้นานๆ ระบบอาจมีปัญหานะครับ หากเร่งด่วนติดต่อพี่ๆทาง Facebook Fanpage ได้เลยครับ</h6></center>');
			...
			function getRegistered(api_token){
				...
				$.post("/api/index.php/user/lite",{
					...
					/*
						...
						/*** /Added for storage ***/
						alert('ปิดรับสมัครแล้วจ้า');
						window.location = "http://www.comcamp.in.th";
					} else {
							...
							<div id="registered" style="display:none;" ng-hide="upload==1">
								...
								<div class="row">
									<div class="col-md-8 col-md-offset-2" style="text-align:left;">
											<h4>น้องๆยังสมัครอัพโหลดเอกสารอื่นๆ ตามมาภายใน 7 วันหลังจากปิดรับสมัครนะครับ :)</h4>
									</div>
								</div>
								<div class="row">
									<div class="col-md-8 col-md-offset-2">
