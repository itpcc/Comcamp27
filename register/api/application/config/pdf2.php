<?php  if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	$config['pdf_path']	= '/home/comcamp/domains/comcamp.in.th/testflight_dir/register_pdf/';
	...
	$config['printData'] = array(
		1 => array(
			...
			array("home_address", array(30, 179.80, 60)), //+6.5
		...
		2 => array(
			...
			array("computer_reward_detail", array(30, 119, 38), "%s"),//+6.5
