...
?><!DOCTYPE html>
	<head>
		...
		<style type="text/css">
			...
			#countdown .countDays, #countdown .countDiv0{
	...
	<div id="header" style="text-align:center;">
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-md-6 embed-responsive embed-responsive-16by9">
							<iframe width="560" height="315" src="https://www.youtube.com/embed/oloO37wXoCs" frameborder="0" allowfullscreen class="embed-responsive-item"></iframe>
						</div>
					</div>
					<div class="row">
						<br>
						<div class="col-md-12" style="text-align:center;">
							<a href="http://register.comcamp.in.th/upload.php" class="btn btn-lg btn-primary" id="regis-button" >เข้าสู่ระบบอัพโหลดเอกสาร</a>
						</div>
					</div>
				</div>
			</section>
		...
		<script type="text/javascript">
			$(function(){				
				var ts = new Date(2015, 3-1, 20, 10, 0, 0, 0);
				/*var note = $('#note');*/
				$('#countdown').countdown({
					timestamp	: ts,
