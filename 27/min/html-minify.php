...
function html_minify_buffer($html)
{
	...
	{
		require_once __DIR__.'/absolute-to-relative-urls.php';
	}
	
	$result_html = new HTML_Minify($html);

	if(isset($GLOBALS['cachePath'])){
		@file_put_contents($GLOBALS['cachePath'], $result_html);
	}
	return $result_html;
}
