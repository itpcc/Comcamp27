<?php
	...
	$cachePath = sys_get_temp_dir().'/index-'.filemtime(__FILE__).'.php.cache';  /* set temporary file name depended file modification date of this file */
	if(
	...
	<body>
					...
					<div class="row">
						<div class="col-md-7">
							<h1 style="text-align:center;">Comcamp 27<sup>th</sup></h1>
								<h3 style="text-align:center; line-height:180%;">โครงการฝึกอบรมเชิงปฏิบัติการคอมพิวเตอร์&#8203;เบื้องต้น ครั้งที่ 27</h3>
								<hr>
								<p>
						...
						<div class="col-md-5 embed-responsive embed-responsive-16by9">
							<iframe width="560" height="auto" src="https://www.youtube.com/embed/oloO37wXoCs" frameborder="0" allowfullscreen class="embed-responsive-item"></iframe>
						</div>
					</div>
					<div class="row">
						<br>
						<div class="col-md-12" style="text-align:center;">
							<a href="http://result.comcamp.in.th/" class="btn btn-lg btn-primary regis-button" id="regis-button-top" >ประกาศผลค่ายแล้วจ้า คลิกเข้าไปดูได้เลยที่นี่</a>
						</div>
					</div>
				</div>
			</section>
					...
					<div class="row">
						<div class="col-md-12" style="text-align:center;">
							...
							<div class="row sponsor-row"><!-- Main supporter -->
								<a href="http://www.leadinnovation.co.th/" target="_blank" class="icon-lead-innovation" style="margin-left: 30px;">บริษัท ลีด อินโนเวชั่น จำกัด</a>
								<a href="http://www.ait-international.com/" target="_blank" class="icon-ait" style="margin-left: 30px;">Advanced Information Technology PCL</a>
								<a href="http://boonrawd.co.th/" target="_blank" class="icon-singha" style="margin-left: 30px;">น้ำดื่มคุณภาพ น้ำดื่มตราสิงห์</a>
								<a href="http://www.camphub.in.th/" target="_blank" class="icon-camphub" style="margin-left: 30px;">Camphub.in.th</a>
							</div><!-- Main supporter -->
					...
					<div class="container">
						...
						<div class="row hidden-xs hidden-sm">
							<div class="col-md-3 subject-badge">
								<img src="assets/img/original/SUB_C.png">
								<!-- img src="assets/img/img-lg/SUB_C.png" sizes="(max-width: 30em) 100vw, (max-width: 50em) 50vw, calc(33vw - 100px)" srcset="assets/img/img-xs/SUB_C.png 384w, assets/img/img-sm/SUB_C.png 768w, assets/img/img-md/SUB_C.png 992w, assets/img/original/SUB_C.png 1200w" alt="C Programming" -->
								<h3>C Programming</h3>
								<p>แปลงความคิดให้กลายเป็นโค้ด เพื่อสร้างสรรค์โปรแกรมของน้องๆเอง</p>
							</div>
							<div class="col-md-3 subject-badge">
								<img src="assets/img/original/SUB_Robot.png">
								<!-- img src="assets/img/img-lg/SUB_Robot.png" sizes="(max-width: 30em) 100vw, (max-width: 50em) 50vw, calc(33vw - 100px)" srcset="assets/img/img-xs/SUB_Robot.png 384w, assets/img/img-sm/SUB_Robot.png 768w, assets/img/img-md/SUB_Robot.png 992w, assets/img/original/SUB_Robot.png 1200w" alt="Robot" -->
								<h3>Robot</h3>
								<p>นำความซับซ้อนทางกลไก ผสมผสานกับการเขียนโปรแกรม เพื่อสร้างความเป็นไปได้ที่ไม่สิ้นสุด</p>
							</div>
							<div class="col-md-3 subject-badge">
								<img src="assets/img/original/SUB_WEB.png">
								<!-- img src="assets/img/img-lg/SUB_WEB.png" sizes="(max-width: 30em) 100vw, (max-width: 50em) 50vw, calc(33vw - 100px)" srcset="assets/img/img-xs/SUB_WEB.png 384w, assets/img/img-sm/SUB_WEB.png 768w, assets/img/img-md/SUB_WEB.png 992w, assets/img/original/SUB_WEB.png 1200w" alt="Web Development" -->
								<h3>Web Development</h3>
								<p>เรียนรู้เทรนด์ใหม่ๆ ในการทำเว็บไซต์ ตั้งแต่นับหนึ่งจนถึงขั้นตอนของการหารายได้</p>
							</div>
							<div class="col-md-3 subject-badge">
								<img src="assets/img/original/SUB_LINUX.png">
								<!-- img src="assets/img/img-lg/SUB_LINUX.png" sizes="(max-width: 30em) 100vw, (max-width: 50em) 50vw, calc(33vw - 100px)" srcset="assets/img/img-xs/SUB_LINUX.png 384w, assets/img/img-sm/SUB_LINUX.png 768w, assets/img/img-md/SUB_LINUX.png 992w, assets/img/original/SUB_LINUX.png 1200w" alt="Linux" -->
								<h3>Basic Linux</h3>
						...
						<div class="row visible-xs-block visible-sm-block">
							<div class="row">
								<div class="col-xs-5 subject-badge-xs">
									<img src="assets/img/img-lg/SUB_C.png">
									<!-- img src="assets/img/img-lg/SUB_C.png" sizes="(max-width: 30em) 100vw, (max-width: 50em) 50vw, calc(33vw - 100px)" srcset="assets/img/img-xs/SUB_C.png 384w, assets/img/img-sm/SUB_C.png 768w, assets/img/img-md/SUB_C.png 992w, assets/img/original/SUB_C.png 1200w" alt="C Programming" -->
								</div>
								<div class="col-xs-7">
									<h4>C Programming</h4>
							...
							<div class="row">
								<div class="col-xs-5 subject-badge-xs">
									<img src="assets/img/img-lg/SUB_Robot.png">
									<!-- img src="assets/img/img-lg/SUB_Robot.png" sizes="(max-width: 30em) 100vw, (max-width: 50em) 50vw, calc(33vw - 100px)" srcset="assets/img/img-xs/SUB_Robot.png 384w, assets/img/img-sm/SUB_Robot.png 768w, assets/img/img-md/SUB_Robot.png 992w, assets/img/original/SUB_Robot.png 1200w" alt="Robot" -->
								</div>
								<div class="col-xs-7">
									<h4>Robot</h4>
							...
							<div class="row">
								<div class="col-xs-5 subject-badge-xs">
									<img src="assets/img/img-lg/SUB_WEB.png">
									<!-- img src="assets/img/img-lg/SUB_WEB.png" sizes="(max-width: 30em) 100vw, (max-width: 50em) 50vw, calc(33vw - 100px)" srcset="assets/img/img-xs/SUB_WEB.png 384w, assets/img/img-sm/SUB_WEB.png 768w, assets/img/img-md/SUB_WEB.png 992w, assets/img/original/SUB_WEB.png 1200w" alt="Web Development" -->
								</div>
								<div class="col-xs-7">
							...
							<div class="row">
								<div class="col-xs-5 subject-badge-xs">
									<img src="assets/img/img-lg/SUB_LINUX.png">
									<!-- img src="assets/img/img-lg/SUB_LINUX.png" sizes="(max-width: 30em) 100vw, (max-width: 50em) 50vw, calc(33vw - 100px)" srcset="assets/img/img-xs/SUB_LINUX.png 384w, assets/img/img-sm/SUB_LINUX.png 768w, assets/img/img-md/SUB_LINUX.png 992w, assets/img/original/SUB_LINUX.png 1200w" alt="Linux" -->
								</div>
								<div class="col-xs-7">
									<h4>Basic Linux</h4>
						...
						<div class="row">
							<br>
							<div class="col-md-12" style="text-align:center;">
								<a href="http://result.comcamp.in.th/" class="btn btn-lg btn-primary regis-button" id="regis-button-buttom" >ประกาศผลค่ายแล้วจ้า คลิกเข้าไปดูได้เลยที่นี่</a>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="row">
						<div class="col-sm-8 col-sm-offset-2" style="text-align:center;">
							...
							<table class="table">
								...
								<tr>
									<td>12/03/2015</td><td>วันสุดท้ายในการสมัครเข้าร่วมโครงการ</td>
								</tr>
								<tr>
									<td>20/03/2015</td>
									<td>ประกาศรายชื่อผู้มีสิทธิ์เข้าร่วมโครงการ <!-- span id="result-countdown"></span --></td>
								</tr>
								<tr>
				...
				<div class="container white">
					<div class="row">
						<div class="col-md-12">
							...
							<hr>
							<p class="question">Q: ผมเรียนอยู่ ม.3 กำลังจะขี้น ม.4 / ผมกำลังเรียน ปวช. สมัครได้ไหมครับ?</p>
							<p>A: ค่ายคอมแคมป์รับเฉพาะน้องๆ ที่ศึกษาอยู่ในระดับชั้น ม.ปลาย ในปีการศึกษา 2557 ซึ่งก็คือ น้องๆ ม.4 ขี้น ม.5, ม.5 ขี้น ม.6 หรือน้องๆ ม.6 ที่กำลังเตรียมแอดมิชชั่นก็สมัครได้เช่นกันนะ</p>
							<hr>
							<p class="question">Q: สมัครผ่านระบบรับสมัครออนไลน์แล้ว ต้องส่งใบสมัครไหมคะ?</p>
							<p>A: ต้องส่งนะครับ เพราะว่าใบสมัครที่ออกโดยระบบออนไลน์ ยังมีส่วนของคำถามค่าย ที่น้องๆจะต้องเขียนตอบด้วยลายมือ หลังจากนั้นเมื่อน้องๆตอบคำถามเสร็จเรียบร้อย ก็ต้องส่งใบสมัครมาให้พี่ๆตามวิธีที่น้องสะดวกครับ (รายละเอียดเพิ่มเติมดูในใบสมัครเลยจ้า)</p>
						</div>
					</div>
					<!-- div class="row">
						<div class="col-md-6">
							...
							<div class="fb-post" data-href="https://www.facebook.com/KMUTTcomcamp/photos/a.150699348416135.35457.145236308962439/457274487758618/?type=1" data-width="466">
								<div class="fb-xfbml-parse-ignore">
									<a href="https://www.facebook.com/KMUTTcomcamp/photos/a.150699348416135.35457.145236308962439/457274487758618/?type=1">Post</a> by <a href="https://www.facebook.com/KMUTTcomcamp">Comcamp KMUTT</a>.
								</div>
							</div>
						</div>
						<div class="col-md-6">
							<div class="fb-post" data-href="https://www.facebook.com/KMUTTcomcamp/photos/a.150699348416135.35457.145236308962439/456075684545165/?type=1" data-width="466"><div class="fb-xfbml-parse-ignore"><a href="https://www.facebook.com/KMUTTcomcamp/photos/a.150699348416135.35457.145236308962439/456075684545165/?type=1">Post</a> by <a href="https://www.facebook.com/KMUTTcomcamp">Comcamp KMUTT</a>.</div></div>
						</div>
						<div class="col-md-6">
							<div class="fb-post" data-href="https://www.facebook.com/KMUTTcomcamp/photos/a.150699348416135.35457.145236308962439/454816941337706/?type=1" data-width="466"><div class="fb-xfbml-parse-ignore"><a href="https://www.facebook.com/KMUTTcomcamp/photos/a.150699348416135.35457.145236308962439/454816941337706/?type=1">Post</a> by <a href="https://www.facebook.com/KMUTTcomcamp">Comcamp KMUTT</a>.</div></div>
						</div>
						<div class="col-md-6">
							<div class="fb-post" data-href="https://www.facebook.com/KMUTTcomcamp/photos/a.150699348416135.35457.145236308962439/452169088269158/?type=1" data-width="466"><div class="fb-xfbml-parse-ignore"><a href="https://www.facebook.com/KMUTTcomcamp/photos/a.150699348416135.35457.145236308962439/452169088269158/?type=1">Post</a> by <a href="https://www.facebook.com/KMUTTcomcamp">Comcamp KMUTT</a>.</div></div>
						</div>
					</div -->
					<div class="row">
						<br>
						<div class="col-md-12" style="text-align:center;">
							<a href="http://result.comcamp.in.th/" class="btn btn-lg btn-primary regis-button" id="regis-button-foot" >ประกาศผลค่ายแล้วจ้า คลิกเข้าไปดูได้เลยที่นี่</a>
						</div>
					</div>
				</div>
			</section>
		...
		<script type="text/javascript">
			$(document).ready(function(){
				var dateTime = new Date(2015, 3-1, 20, 20, 0, 0, 0);
				moment.locale('th');
				//$(".regis-button, #result-countdown").livestamp(dateTime);
				//$(".regis-button, #result-countdown").html("ใกล้ประกาศผลแล้ว รอสักครู่นะครับ :)");
			});
		</script>
	</body>
</html>
